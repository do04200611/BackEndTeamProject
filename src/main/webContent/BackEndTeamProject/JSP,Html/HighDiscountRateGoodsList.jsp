...
<body>	
		...
		<a class="today">오늘의</a>
			...
			<div class="column">
				...
				<p id="appleexplation">첫 출하 빨간 가정용 햇 사과</p>
				<p id="appleexplation">5KG, (16~22과)중과 5KG</p>
			</div>
			<div class="column">
				<img src="../../images/napacabbage.png" id="napcabbageimage">
				<p id="napcabbageimageexplation">봄동 2kg 최상급 봄동배추 고</p>
				<p id="napcabbageimageexplation">소한 봄동나물</p>
			</div>
			<div class="column">
				<img src="../../images/napacabbage.png" id="napcabbageimage2">
				<p id="napcabbageimageexplation2">봄동 2kg 최상급 봄동배추 고</p>
				<p id="napcabbageimageexplation2">소한 봄동나물</p>
			</div>
			<div class="column">
				<img src="../../images/napacabbage.png" id="napcabbageimage3">
				<p id="napcabbageimageexplation3">첫 출하 고당도 성주 참외</p>
				<p id="napcabbageimageexplation3">2kg(당일배송),2kg(5~11...</p>
			</div>
			<div class="column">
				<img src="../../images/napacabbage.png" id="napcabbageimage4">
				<p id="napcabbageimageexplation4">참도깨 부산 깡통시장 당면</p>
				<p id="napcabbageimageexplation4">만두 20개입, 2개</p>
			</div>
